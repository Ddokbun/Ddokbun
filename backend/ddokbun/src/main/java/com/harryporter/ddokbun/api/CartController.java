...
public class CartController {
    ...
    public ResponseEntity<?> checkCartItemByItemSeq(@PathVariable("itemSeq") Long itemSeq,@ApiIgnore @AuthenticationPrincipal UserSimpleDto userSimpleDto){

        log.info("장바구니에 아이템 존재 여부 확인 API userSeq : {} :: itemSeq : {}",userSimpleDto.getUserSeq(),itemSeq);

        int result = cartService.isExists(itemSeq,userSimpleDto.getUserSeq());
